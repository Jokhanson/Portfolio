      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-0 z-50 flex justify-end bg-black/30 backdrop-blur-md md:hidden"
          >
            <motion.div
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              ...
              className="w-[280px] bg-[#0A0A0F] border-l border-white/[0.08] shadow-[-8px_0_30px_rgba(0,0,0,0.5)] flex flex-col"
            >
