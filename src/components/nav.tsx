        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-[280px] z-50 bg-[#0A0A0F]/60 backdrop-blur-2xl border-l border-white/[0.08] shadow-[-8px_0_30px_rgba(0,0,0,0.5)] flex flex-col md:hidden"
            >
